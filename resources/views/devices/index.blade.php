                    ...
                    <table class="table table-bordered mt-2">
                        ...
                        @foreach ($devices as $device)
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        <a href="{{ route('devices.edit', $device->id) }}" class="btn btn-sm btn-info"
                                            data-toggle="tooltip" data-placement="top" title="Edit Device"><i
                                                class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                        <a href="{{ route('devices.delete', $device->id) }}" class="btn btn-sm btn-danger"
                                            data-toggle="tooltip" data-placement="top" title="Delete Device">
                                            <i class="icon-trash"></i>
                                        </a>
                                        <a href="{{ route('devices.fetch', $device->id) }}" class="btn btn-sm btn-success"
                                            data-toggle="tooltip" data-placement="top" title="Fetch Attendance"><i
