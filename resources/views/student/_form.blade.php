    ...
    <div class="col-lg-4">
        <div class="card mb-2">
            <div class="card-body text-center">
                <img src="{{ URL::asset('assets/img/profile.jpg') }}" alt="avatar" class="rounded-circle img-fluid"
                    style="width: 150px;">
    ...
    <div class="col-lg-8">
        <div class="card mb-1">
            <div class="card-body">
                ...
                <div class="row mt-2">
                    <label for="building" class="col-sm-2 col-form-label">Building Assignment</label>
                    <div class="col-sm-3">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="row">
                            <label for="emergencyContactPerson" class="col-sm-6 col-form-label">Emergency Contact
                                Person</label>
                            <div class="col-sm-6">
